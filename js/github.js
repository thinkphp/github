...
var githubbadge = function() {
    ...
    function init() {
       ...
       if(badge) {
          ...
          if(c.indexOf(config.triggerGit) !== -1) {
               ...
               var repos = "https://api.github.com/users/"+login+"/repos?callback=githubbadge.seed2";
    ...
    function seedContent(json) {
        ...
        if(window.console) console.log(json.data.length)

       //get object vector repositories
       //var repos = array_reverse(json.user.repositories);
